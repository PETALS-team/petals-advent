...
const SocialLinks = ({ instagram, tiktok, youtube }: SocialLinksProps) => {
  const links = [
    {
      name: 'YouTube',
      url: youtube,
    ...
    <div className="flex items-center justify-center gap-4">
      {links.map((link) => (
        <a
          ...
          className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-all ${link.bgClass} ${link.textClass}`}
